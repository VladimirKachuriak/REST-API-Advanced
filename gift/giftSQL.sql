...
BEGIN
    ...
    WHILE counter <= 1000
        DO
            ...
            INSERT INTO user (name, account) VALUES (@tagName, @account);
...
BEGIN
    ...
    WHILE counter <= 100
        DO
            ...
            SET @certificate_id = FLOOR(RAND() * 1000) + 1;
            SET @create_date = NOW();
            SELECT COUNT(*) INTO duplicate_count FROM purchase
